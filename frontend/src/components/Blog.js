...
const Blog = () => {
    ...
    const getBlogs = () => {
        ...
        blogs.map(blogPost => {
            return list.push(
                <>
                <div className="row  no-gutters border  overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative" id="cont">
    ...
    return (
        <div className="container mt-3">
            ...
            <div className="jumbotron p-4 p-md-5 text-white rounded bg-dark blog_head">
                ...
                <Link to={'/'} className="stretched-link "><b>BACK HOME</b></Link>
